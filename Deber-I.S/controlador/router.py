...
def create_user(data_user: UserSchema):
    ...
    #>>> 
    create_user(UserSchema(id="1", nombre="Diego", apellido="Tubay", usuario="Lozano", contraseña="123", telefono="123", direccion="123", correo="123", cedula="123"))
...
def update_user(data_update: UserSchema, user_id: str):
    ...
    #>>>
    update_user("1","Diego","Tubay","Lozano","123","123","123","123","diego@gmail.com")
    #"""
